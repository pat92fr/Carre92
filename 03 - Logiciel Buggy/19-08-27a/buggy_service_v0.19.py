...
class main_controller():
    ...
    def process(self):
        ...
        # based on LIDARs    
            ...
            self.actual_error = constraint(self.lidar_distance_droit - self.lidar_distance_gauche, -150, 150)
        ...
        if(len(fields)>=9):
           ...
           self.telemetry_mode = int(fields[8])   
...
def main():
    ...
    while True:
        ...
        counter += 1
        msg = str(counter) + ';'
        msg += str( float(controller.lidar_distance_gauche) ) + ';' 
        msg += str( float(controller.lidar_distance_droit) ) + ';' 
        msg += str( float(controller.actual_error) ) + ';' 
        msg += str( float(controller.positional_error) ) + ';' 
        ...
        # Local trace
        if fps_counter % 60 == 0:
            print("fps:" + str(fps) + "   DIR:" + str(controller.direction) + "   THR:" + str(controller.throttle) + "   MODE:" + str(controller.mode) + "   LiG:" + str(controller.lidar_distance_gauche)+"   LiD:" + str(controller.lidar_distance_droit))
        fps_counter += 1
