...
# # speed strategy (best 19-10-04)
# def max_speed_from_distance(distance):
#     if distance > 0.0 and distance < 11.0:
#         return param_maximum_speed
#     elif distance > 21.0 and distance < 32.0:
#         return param_maximum_speed
#     elif distance > 54.0 and distance < 62.0: #64m 
#         return param_maximum_speed
#     elif distance > 75.0 and distance < 120.0:
#         return param_maximum_speed
#     else:
#         return param_cornering_speed
...
# speed strategy
def max_speed_from_distance(distance):
    if distance > 0.0 and distance < 10.0:
        return param_maximum_speed
    elif distance > 21.0 and distance < 31.0:
        return param_maximum_speed
    elif distance > 54.0 and distance < 61.0:
        return param_maximum_speed
    elif distance > 75.0 and distance < 115.0:
        return param_maximum_speed
    else:
        return param_cornering_speed
