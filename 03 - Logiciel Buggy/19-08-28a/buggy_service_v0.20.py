...
def main():
    ...
    while True:
        ...
        # Local trace
        if fps_counter % 60 == 0:
            print("fps:" + str(fps) + "   DIR:" + str(controller.direction) + "   THR:" + str(controller.throttle) + "   MODE:" + str(controller.mode) + "   LiG:" + str(controller.lidar_distance_gauche)+"   LiD:" + str(controller.lidar_distance_droit)+"   LiH:" + str(controller.lidar_distance_haut))
        fps_counter += 1
