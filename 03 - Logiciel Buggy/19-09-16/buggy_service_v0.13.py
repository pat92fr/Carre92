...
class buggyHandler(asyncore.dispatcher_with_send):
    ...
    def handle_read(self):
        ...
        if data:
            ...
            if (res[0] == "GET_API"):
                resp = "GET_API;param_kp;param_ki;param_kd;param_min_speed;param_max_speed;param_k_speed"
                print(resp)
            ...
            if (res[0] == "GET"):
                resp = "GET;" + str(param_kp) + ";" + str(param_ki) + ";"  + str(param_kd) + ";"  + str(param_min_speed) + ";"  + str(param_max_speed) + ";"  + str(param_k_speed)
                print(resp)
                self.send(resp.encode("utf-8"))
                print('Response sent.')
                return
...
class buggyServer(asyncore.dispatcher):
    ...
    def process(self):
        ...
        if self.running:
            ...
            if abs(self.pid_wall_following.integral_error) > threshold:
                self.throttle = self.max_speed - self.k_speed*(abs(self.pid_wall_following.integral_error)- threshold)
