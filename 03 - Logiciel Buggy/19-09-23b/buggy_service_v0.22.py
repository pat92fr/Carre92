...
class main_controller():
    ...
    def __init__(self):
        ...
        self.pid_speed = my_controller.pid(kp=70.0, ki=0.0, kd=100.0, integral_max=1000, output_max=50.0, alpha=0.2) 
    ...
    def process(self):
        ...
        # based on LIDARs    
            ...
            self.throttle = int( 128.0 + self.pid_speed.compute(self.speed_error_ms) )
        ...
        log_list.append( float(self.actual_speed_kmh) )
