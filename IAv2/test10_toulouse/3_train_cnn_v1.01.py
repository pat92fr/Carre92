...
print(str(m_train))
X_train = X_shuffled[:m_train,:].reshape(m_train,height,width,1)
Y_train = Y_shuffled[:m_train]
X_test = X_shuffled[m_train:,:].reshape(m-m_train,height,width,1)
...
# CONV 30epochs 
model.add(Conv2D(8, kernel_size=(1, 5), strides=(1, 1), dilation_rate = (1,1), border_mode='same', activation='relu', input_shape=inmage_shape))
...
model.add(AveragePooling2D(pool_size=(2, 2)))
#40x4
model.add(Conv2D(4, kernel_size=(3, 3), strides=(1, 1), dilation_rate = (1,1), border_mode='same', activation='relu'))
model.add(AveragePooling2D(pool_size=(2, 2)))
#20x2
...
##model.add(MaxPooling2D(pool_size=(2, 1)))
##model.add(Conv2D(16, kernel_size=(7, 7), strides=(1, 1), dilation_rate = (1,1), border_mode='same', activation='relu'))
##model.add(Conv2D(2, kernel_size=(7, 7), strides=(1, 1), dilation_rate = (1,1), border_mode='same', activation='relu'))
##model.add(MaxPooling2D(pool_size=(2, 1)))
...
# CONV 49 86
##model.add(Conv2D(4, kernel_size=(5, 5), strides=(1, 1), dilation_rate = (2,1), border_mode='same', activation='relu', input_shape=inmage_shape))
##model.add(Conv2D(4, kernel_size=(7, 7), strides=(1, 1), dilation_rate = (2,1), border_mode='same', activation='relu'))
##model.add(MaxPooling2D(pool_size=(2, 1)))

# CONV 78 64
##model.add(Conv2D(4, kernel_size=(5, 5), strides=(1, 1), dilation_rate = (1,1), border_mode='same', activation='relu', input_shape=inmage_shape))
##model.add(MaxPooling2D(pool_size=(2, 2)))
##model.add(Conv2D(4, kernel_size=(5, 5), strides=(1, 1), dilation_rate = (1,1), border_mode='same', activation='relu', input_shape=inmage_shape))
##model.add(AveragePooling2D(pool_size=(2, 2)))

# CONV 84 113
##model.add(Conv2D(3, kernel_size=(5, 5), strides=(1, 1), dilation_rate = (1,1), border_mode='same', activation='relu', input_shape=inmage_shape))
##model.add(AveragePooling2D(pool_size=(2, 1)))

# CONV 36 51
##model.add(Conv2D(4, kernel_size=(5, 5), strides=(1, 1), dilation_rate = (2,2), border_mode='same', activation='relu', input_shape=inmage_shape))
##model.add(Conv2D(4, kernel_size=(5, 5), strides=(1, 1), dilation_rate = (1,1), border_mode='same', activation='relu', input_shape=inmage_shape))
##model.add(Conv2D(4, kernel_size=(5, 5), strides=(1, 1), dilation_rate = (1,1), border_mode='same', activation='relu', input_shape=inmage_shape))
##model.add(AveragePooling2D(pool_size=(2, 1)))
