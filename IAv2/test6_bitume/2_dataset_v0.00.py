...
X_train = np.zeros((width*crop_height*3,m*3))
...
for i in range(0,m):
    ...
    im_croped = im_resized[height-height_end:height-height_start,:width]
    assert(im_croped.shape == (crop_height,width,3))
    ...
    for j in range(0,3):
        ...
        assert(x.shape == (crop_height*width*3,1))
