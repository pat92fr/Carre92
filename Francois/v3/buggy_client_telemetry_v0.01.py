...
def main():
    ...
    sampleCtx[1]  = { "title": "LIG",          "unit": "cm", "color": "--k",  "enable": 1, "factor": 1.0, "plot": 0}
    sampleCtx[2]  = { "title": "LID",          "unit": "cm", "color": "-b",   "enable": 1, "factor": 1.0, "plot": 0}
    sampleCtx[3]  = { "title": "LIH",          "unit": "cm", "color": "--r",  "enable": 1, "factor": 1.0, "plot": 0}
    sampleCtx[4]  = { "title": "LIDAR error",  "unit": "cm", "color": ":g",   "enable": 1, "factor": 1.0, "plot": 0}
    sampleCtx[5]  = { "title": "LIDAR error2", "unit": "cm", "color": "--k",  "enable": 1, "factor": 1.0, "plot": 1}
    sampleCtx[6]  = { "title": "PID Lidar",    "unit": "",   "color": "--k",  "enable": 1, "factor": 1.0, "plot": 2}
    sampleCtx[7]  = { "title": "PID AI",       "unit": "",   "color": "-b",   "enable": 1, "factor": 1.0, "plot": 2}
    sampleCtx[8]  = { "title": "Direction",    "unit": "",   "color": "--k",  "enable": 1, "factor": 1.0, "plot": 3}
    sampleCtx[9]  = { "title": "Gaz",          "unit": "",   "color": ":g",   "enable": 1, "factor": 1.0, "plot": 3}
