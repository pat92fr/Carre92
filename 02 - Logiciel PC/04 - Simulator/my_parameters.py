...
##    ('maxpooling3D', (1,2,2), (1,2,2)),
    ...
    ('conv3D', 24, (3,5,5), (1,2,2)),           ## filters, kernel_size, stride
    ('conv3D', 32, (3,5,5), (1,2,2)),           ## filters, kernel_size, stride
    ('conv3D', 64, (2,3,3), (1,2,2)),           ## filters, kernel_size, stride
    ('conv3D', 64, (1,3,3), (1,1,1)),           ## filters, kernel_size, stride
    ('conv3D', 64, (1,3,3), (1,1,1)),           ## filters, kernel_size, stride
