...
model = Sequential()
# CONV
model.add(Conv2D(16, kernel_size=(5, 5), strides=(2, 2), dilation_rate = (1,1), border_mode='same', activation='relu', input_shape=inmage_shape))
model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
model.add(Conv2D(32, kernel_size=(7, 7), strides=(2, 2), dilation_rate = (1,1), border_mode='same', activation='relu', input_shape=inmage_shape))
model.add(MaxPooling2D(pool_size=(2, 2), strides=(2, 2)))
