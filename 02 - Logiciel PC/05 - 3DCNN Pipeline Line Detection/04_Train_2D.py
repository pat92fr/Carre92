...
picture_shape = (const.picture_initial_height, const.picture_initial_width, 1)
...
Xtrain = np.load(params.dataset_train_valid_2D_dir + '/Xtrain.bin.npy', )
Ytrain = np.load(params.dataset_train_valid_2D_dir + '/Ytrain.bin.npy')
Xvalid = np.load(params.dataset_train_valid_2D_dir + '/Xvalid.bin.npy')
Yvalid = np.load(params.dataset_train_valid_2D_dir + '/Yvalid.bin.npy')
print("Done.")
...
# design model
model = mtools.build_model(picture_shape, params.conv_layers, params.full_connected_hidden_layers, 1, params.hyp_l2_regularization)
# compile model
